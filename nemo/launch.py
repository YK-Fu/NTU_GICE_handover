...
def main(cfg) -> None:
    ...
    if cfg.gpt_model_file:
        ...
        # pretrained_cfg.tokenizer.type = "/new_scripts/original_llama3_instruct"
        # pretrained_cfg.seq_len_interpolation_factor = 0.5
...
#         inputs=[prompt], length_params=length_params, sampling_params=sampling_params)

#         if fp8_enabled:
#             response = remove_padded_prompts(response, nb_paddings)
#         response = response['sentences'][0]
#         print('Chatbot:', response[response.find('User'):])
